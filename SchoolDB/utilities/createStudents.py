...
import SchoolDB
default_csv_file = \
"/home/master/SchoolsDatabase/phSchoolDB/upload_data/data_for_student_db_build.csv"
default_net_csv_file = \
                     "/upload_data/data_for_student_db_build.csv"
#Global value that defines how many students will be created in a section
    ...
    def set_class_year_dependant_values(self):
        ...
        if (self.class_year == "First Year"):
            self.values_dict["elementary_graduation_date"] = \
                str(base_elementary_graduation_date)
            self.values_dict["student_major"] = ""
            self.values_dict["student_major_change_date"] = "0"
        else:
            self.values_dict["student_major"] = random.choice(self.majors_list)
            if (self.class_year == "Second Year"):
                offset = -365
            ...
            self.values_dict["student_major_change_date"] = \
                str(base_change_date + offset + 365)
...
if __name__ == '__main__':
    ...
    p.set_defaults(csv_filename=default_csv_file)
