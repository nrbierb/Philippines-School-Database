#!/usr/bin/python
"""
A quick file to parse the localities web page
"""
import csv, cPickle, bz2, os, optparse, logging
...
pickle_filename = "/home/master/SchoolsDatabase/phSchoolDB/upload_data/localities.bz2"
#filename = "/upload_data/localities.pbz"
class Muni():
...
def read_pickle(filename):
    if (os.path.exists(filename)):
        ...
        return cPickle.loads(data_string)
...
if __name__ == "__main__":
    ...
    p.set_defaults(delete_current=False,
