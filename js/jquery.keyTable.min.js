...
return I.aoData[I.aiDisplay[J]].nTr.getElementsByTagName("td")[H]}else{return jQuery("tr:eq("+J+")>td:eq("+H+")",f)[0]
}}function j(H){return[jQuery("td",H.parentNode).index(H),jQuery("tr",H.parentNode.parentNode).index(H.parentNode)]
