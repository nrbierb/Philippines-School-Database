...
if __name__ == '__main__':
    logging.info("School Student Summaries: Starting update of all schools.")
    update_all_schools_summaries()
    logging.info("School Student Summaries:Completed all task initiations")