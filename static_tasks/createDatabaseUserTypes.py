...
def build_teacher_permissions():
    ...
    class_permissions = {
        "administrator":standard_broad_view,
...
def build_school_db_administrator_permissions():
    ...
    class_permission_changes = {
        "achievement_test":local_edit_broad_view,
        "administrator":local_edit_broad_view,
